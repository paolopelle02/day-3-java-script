...
while (index < starWarsCharacters.length) {
  Mass += starWarsCharacters[equipaggio].mass;
  i++;
}
...
// ESERCIZIO 9
const characterNamesToRemove = femaleCharacters.map(character => character.name);
charactersNames.splice(
  charactersNames.findIndex(name => characterNamesToRemove.includes(name)),
  characterNamesToRemove.length
);
console.log('Length prima dell\'operazione:', charactersNames.length);
console.log('Length dopo l\'operazione:', charactersNames.length);
